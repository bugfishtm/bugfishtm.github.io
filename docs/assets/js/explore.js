/* ============================================================
   BUGFISH — explore.js
   Renders the channel link cards from data/explore.json into
   #explore-list on the Channels page (channels.html).
...
function renderExplore(items) {
  ...
  if (!Array.isArray(items) || !items.length) {
    list.innerHTML = `<div class="news-empty">// no channels yet</div>`;
    return;
  }
