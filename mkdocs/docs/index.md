# Projects
Access documentation for all my projects. These are included in the respective repositories (`docs` folder) and work with HTML/JS/CSS, making them accessible on any device without requiring a web server. 
